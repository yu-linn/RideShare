...
public class Driver implements Serializable {
	...
	public Driver(String userID, int eventID, String postContent, String meetingAddress,
				  List<Integer> meetGeoloc, String meetDatetime, int totalSeats, float price) {
    ...
    public Driver(String userID, int eventID, String postContent, String meetingAddress,
        ...
        this(userID, eventID, postContent, meetingAddress, meetGeoloc, meetDatetime, numSeatsLeft, 0);
    }
	...
	public boolean equals(Driver driver) {
		return (this.userID == driver.userID && this.eventID == driver.eventID);
	}
